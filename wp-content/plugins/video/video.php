...
class VideoPress {
	...
	public function print_admin_scripts() {
		...
		window.addEventListener( "message", function(e) {
			...
			if ( e.data.action == "vpInsertShortcode" ) {
				var guid = e.data.content ? e.data.content.toString() : "";
